	...
	<AlertDialog.Content class="max-w-lg">
		<AlertDialog.Header>
			<AlertDialog.Title class="flex items-center gap-2">
				<AlertTriangle class="h-5 w-5 text-neutral-500" />
				Model Not Available
			</AlertDialog.Title>
		...
		<div class="space-y-3">
			<div class="rounded-lg border border-neutral-500/40 bg-neutral-500/10 px-4 py-3 text-sm">
				<p class="font-medium text-neutral-600 dark:text-neutral-400">
					Requested: <code class="rounded bg-neutral-500/20 px-1.5 py-0.5">{modelName}</code>
				</p>
			</div>
