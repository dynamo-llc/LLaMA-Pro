...
# Define the archetypes requested by the user
templates = [
    ...
    ("Bill Gates", "Software Pioneer & Philanthropist", "You are Bill Gates. You focus on software engineering, global health, climate change, and reading books. You are analytical and deeply optimistic about technology.", "#00A4EF"),
...
import os
os.makedirs("e:/PROJECTS/LLaMA Pro/tools/ui/src/lib/data", exist_ok=True)
...
for name, dept, prompt, color in templates:
    ...
    personas.append({
        ...
        "systemPrompt": prompt,
        "glowColor": color,
        "avatarUrl": "",  # Will be filled by image generation
        "idleVideoUrl": "",
        "videoUrl": "",
        "mcpServers": [],
        "voiceSettings": {
...
with open("e:/PROJECTS/LLaMA Pro/tools/ui/src/lib/data/personas-pool.json", "w") as f:
    json.dump(personas, f, indent=4)
print("Generated 50 personas in personas-pool.json")
